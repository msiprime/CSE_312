...
public class Client03FormController {
    ...
    public void initialize() {
        ...
        lblClient.setText(chat_application_project.controller.LoginForm03Controller.name);
                    ...
                    Platform.runLater(new Runnable() {
                        ...
                        public void run() {
                            if (message.startsWith("/")) {
                                ...
                                i += 150;
                            } else if (message.startsWith(chat_application_project.controller.LoginForm03Controller.name)) {
